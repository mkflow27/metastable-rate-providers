...
describe('mainnet fork ERC4626 rate provider', function () {
  ...
  beforeEach('deploy rate provider', async () => {
    ...
    erc4626RateProvider = await Erc4626RateProvider.deploy('0xac3E018457B222d93114458476f3E3416Abbe38F');
  });
  ...
  it('checks decimals are the same', async () => {
    expect(await erc4626RateProvider.vaultDecimals()).to.equal(18);
  });
});
